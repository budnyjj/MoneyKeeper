...
public class EditManagerAmountOutcome implements IEditManagerAmount {
    ...
    public EditManagerAmountOutcome(EditText editText, TextInputLayout inputLayout,
